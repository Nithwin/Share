...
const Communicate = () => {
  return (
    <div className='flex flex-col px-[1.5rem] py-[2rem] gap-10 max-w-[70rem] mx-auto lg:flex-row items-center lg:py-0'>
      <div className='lg:w-1/2'>
        <img src="/assets/Group-1.png" alt="Group" className='w-[20rem] lg:w-[28rem]' />
      </div>
